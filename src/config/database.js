...
const connection= async  ()=>{
  await mongoose.connect('mongodb+srv://shettymanoj111:qYeTATP5F4JItHUw@cluster0.luureav.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0/devTinder');  // connectimg particular cluster
